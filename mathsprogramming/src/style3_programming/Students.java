...
public class Students {
	...
	public Students(double tenth,double inter,double degree,String name1,String loc)
	{
		percentage=tenth;
		interper=inter;
		degreePre=degree;
	...
	{
		Students st1 = new Students(89.0, 77.0, 65.0, "Bharat", "Vijayawada");
		Students st2 = new Students(95.0, 90.0, 68.0, "Vamsi", "Gudivada");
